...
\Title{Support %MDPI: Title is different from the one in our system. Please check and confirm which version is correct. % Author: Yes, the title is changed from the previous in the system. This version is correct: "Support Vector Machine Algorithm for Mapping Land Cover Dynamics in Senegal, West Africa, Using Earth Observation Data "
...
\Author{Polina %MDPI: Please carefully check the accuracy of names and affiliations. % Author: yes, correct.
...
\AuthorCitation{Lemenkova, %MDPI: Please carefully check the accuracy of names. % Author: yes, correct.
 P.}
