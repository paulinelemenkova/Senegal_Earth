...
\Title{{\highlighting{Support} %MDPI: Title is different from the one in our system. Please check and confirm which version is correct.
...
\Author{\hl{Polina} %MDPI: \hl{} %MDPI: Please carefully check the accuracy of names and affiliations.
...
\AuthorCitation{\hl{Lemenkova,} %MDPI: \hl{} %MDPI: Please carefully check the accuracy of names.
 P.}
% If this is a Chicago style journal: Lastname, Firstname, Firstname Lastname, and Firstname Lastname.

% Affiliations/Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Department of Geoinformatics, Faculty of Digital and Analytical Sciences, Paris Lodron Universität Salzburg, Schillerstraße 30, A-5020 Salzburg, Austria; polina.lemenkova@plus.ac.at or \highlighting{polina.lemenkova2@unibo.it;} %MDPI: Please check if both e mails should be retained.
\linebreak Tel.: (+43)-677-6173-2772 or (+39)-344-69-28-732

$^{2}$ \quad Department of Biological, Geological and Environmental Sciences, Alma Mater Studiorum---Università di Bologna, Via Irnerio 42, IT-40126 Bologna, \hl{EM,} %MDPI: Italian region abbreviated. Please check. Also, please check if it can be removed.
 Italy
}
...
\abstract{This paper addresses the problem of mapping land cover types in Senegal and recognition of vegetation systems in the Saloum River Delta on the satellite images. Multi-seasonal landscape dynamics {were} analyzed {using} Landsat 8-9 OLI/TIRS {images} from 2015 to 2023{. Two image classification methods were compared, and their performance was evaluated in the\highlighting{ GRASS GIS software} %MDPI: Please state the software version number, creator, and the location (city, country) from where the software was sourced.
 by means of unsupervised classification using the k-means  clustering algorithm and supervised classification using the Support Vector Machine (SVM) algorithm}. The land cover types were identified using {machine learning (ML)-based} analysis of {the} spectral reflectance of the multispectral images. The results based on the {processed multispectral} images indicated a decrease in savannas, an increase in croplands and agricultural lands, a decline in forests, and changes to coastal wetlands, including mangroves with high biodiversity. {The practical aim is to describe a novel method of creating land cover maps using RS data for each class and to improve accuracy. We accomplish this by calculating the areas occupied by 10 land cover classes within the target area for six consecutive years. Our results indicate that, in comparing the performance of the algorithms, the SVM classification approach increased the accuracy, \highlighting{with 98\% of pixels being stable}, which shows qualitative improvements in image classification. This} paper contributes to the natural resource management and environmental monitoring of Senegal, West Africa, through  advanced cartographic methods \highlighting{applied to remote sensing of Earth observation data}. %MDPI English: Check meaning is retained.
}
...
\PACS{\hl{91.10.Da;} %MDPI: Please confirm if PACS, MSC and JEL should be retained.
...
To increase the speed and accuracy of image processing, the{ }GRASS GIS software was applied {for} advanced image processing {due to its extended} functionalities~\cite{Neteleretal2008}. Generic Mapping Tools (GMT) Version 6~\cite{Wessel} {was} used as a cartographic tool for \hl{topography, and} %MDPI English: Check meaning is retained.
...
\vspace{-4pt}{}
\begin{table}[H]
\caption{\hl{Identifiers (IDs)} %MDPI: Vertical line removed from the table as it is not allowed. Please check and confirm.
...
\toprule
			...
			\midrule
			\hl{25 February 2015} %MDPI: We revised date format in this column according to our rules. Please check and confirm.
...
\end{adjustwidth}
\caption{\hl{Data capture} %MDPI: Please make sure that cut off content does not affect scientific reading.
...
\caption{Landsat images in RGB colors covering the Cape Verde Peninsula region and Saloum River Delta, West Senegal, in February:\hl{ (\textbf{a}) 2015;} %MDPI: Years removed from labels in the picture since they were also provided in the caption. Please check and confirm. Same below.
...
\end{adjustwidth}
\caption{\hl{Land} cover types in Senegal according to the FAO classification scheme. Software: QGIS v.~3.22. Map source: Author.} %MDPI English: Please carefully check text in all images for errors; here, for example, "brakish" should read "brackish."
\label{fig06}
\end{figure}
...
{The overview of Figure} \ref{fig07}, {on which are overlaid the \hl{2013}--2023 Landsat OLI/TIRS time series and the land cover %MDPI English: Check if this number should be 2015 instead.
...
\caption{Classification of the Landsat images from 2020 covering the Cape Verde Peninsula region and the Saloum River Delta, West Senegal:\hl{ (\textbf{a}) 2015;} (\textbf{b}) 2018; (\textbf{c}) 2020; (\textbf{d}) 2021; (\textbf{e}) 2022; (\textbf{f}) 2023.}\label{fig07}
\end{figure}  
...
\caption{{\hl{Results} %MDPI: Please check if SVM:Year is necessary since years are already presented in the caption for each label of the subfigures.
...
\vspace{6pt}{}
\authorcontributions{\hl{ } %MDPI: Please fill in this part accordingly. Same below.
...
\funding{\hl{ } %MDPI: Funding is necessary for the back part. Please add information considering funding.
%The publication was funded by the Editorial Office of Earth, Multidisciplinary Digital Publishing Institute (MDPI), by providing 100\% discount for the APC of this manuscript.
}


\dataavailability{{\hl{The author's} %MDPI: ICS and IRBS removed as they are not necessary for this manuscript.
...
\hl{ine} %MDPI English: Check if this word/abbreviation is needed here and below, or if this should be deleted.
        ...
        Date Product Generated L2 & \hl{9 September 2020} %MDPI: We revised date format according to our rules. Please check and confirm.
 & \hl{2 September 2020} & \hl{23 August 2020} \\ ine
        Date Product Generated L1 & \hl{9 September 2020} & \hl{2 September 2020} & \hl{23 August 2020} \\ ine
        Start Time & \hl{25 February 2015} 11:27:00.070962 & 17 February 2018 11:26:59.893161 & \hl{7 February 2020} 11:27:15.666422 \\ ine
        Stop Time & \hl{25 February 2015} 11:27:31.840958 & 17 February 2018 11:27:31.663159 & \hl{7 February 2020} 11:27:47.436421 \\ ine
...
ine
        ...
        Scene Center Lat DMS & ''14°27'25.70\hl{''''} %MDPI: Please check if double '' is correct.
N'' & ''14°27'24.62''''N'' & ''14°27'24.37''''N'' \\ ine
        Scene Center Long DMS & ''16°39'49.72\hl{''''}W'' & ''16°38'25.62''''W'' & ''16°38'00.28''''W'' \\ ine
        Corner Upper Left Lat DMS & ''15°29'56.47\hl{''''}N'' & ''15°29'57.59''''N'' & ''15°29'57.84''''N'' \\ ine
...
\hl{ine}
        ...
        Date Acquired & \hl{25 February 2021} & \hl{20 February 2022} & \hl{22 January 2023} \\ ine
        Collection Category & T1 & T1 & T1 \\ ine
        Collection Number & 2 & 2 & 2 \\ ine
        WRS Path & 205 & 205 & 205 \\ ine
        WRS Row & 50 & 50 & 50 \\ ine
        ...
        Nadir/Off Nadir & NADIR & NADIR & NADIR \\ ine
        Roll Angle & 0.000 & 0.000 & 0.000 \\ ine
        Date Product Generated L2 & \hl{4 March 2021} & \hl{27 April 2023} & \hl{13 March 2023} \\ ine
        Date Product Generated L1 & \hl{4 March 2021} & \hl{27 April 2023} & \hl{13 March 2023} \\ ine
        Start Time & \hl{25 February 2021} 11:27:13.15558 & \hl{20 February 2022} 11:27:20 & \hl{22 January 2023} 11:27:31 \\ ine
        Stop Time & \hl{25 February 2021} 11:27:44.925579 & \hl{20 February 2022} 11:27:52 & \hl{22 January 2023} 11:28:03 \\ ine
        Station Identifier & LGN & LGN & LGN \\ ine
        Day/Night Indicator & DAY & DAY & DAY \\ ine
...
ine
        Scene Center Lat DMS & ''14°27'25.24\hl{''''}N'' & ''14°27'25.16''''N'' & ''14°27'24.19''''N'' \\ ine
        Scene Center Long DMS & ''16°38'36.71\hl{''''}W'' & ''16°39'35.46''''W'' & ''16°38'55.97''''W'' \\ ine
        Corner Upper Left Lat DMS & ''15°29'57.37\hl{''''}N'' & ''15°29'46.86''''N'' & ''15°29'47.36''''N'' \\ ine
...
\subsection[\appendixname~\thesubsection]{\hl{Landsat 8} %MDPI: Please check if listings in this part need captions.
 OLI/TIRS Image from February 2015}
\vspace{6pt}{}
\begin{scriptsize}
\begin{verbatim}
Location: Senegal
...
\subsection[\appendixname~\thesubsection]{Landsat 8 OLI/TIRS Image from February 2018}
\begin{scriptsize}
\begin{verbatim}
...
\subsection[\appendixname~\thesubsection]{Landsat 8 OLI/TIRS Image from February 2020}
\begin{scriptsize}
\begin{verbatim}
...
\subsection[\appendixname~\thesubsection]{Landsat 8 OLI/TIRS Image from February 2021}
\begin{scriptsize}
\begin{verbatim}
...
\subsection[\appendixname~\thesubsection]{Landsat 9 OLI/TIRS Image from February 2022}
\begin{scriptsize}
\begin{verbatim}
Location: Senegal
Mapset:   PERMANENT
...
\subsection[\appendixname~\thesubsection]{Landsat 9 OLI/TIRS Image from February 2023}
\begin{scriptsize}
\begin{verbatim}
...
\newblock In Proceedings of the 2021 IEEE International Geoscience and Remote
  Sensing Symposium IGARSS, \hl{Brussels, Belgium, 11--16 July 2021;} %MDPI: We added location and date of the conference. Please check.
 pp. 4704--4707.
...
\newblock Analysis of Sahelian vegetation dynamics using NOAA-AVHRR NDVI data
  from 1981–2003.
\newblock {\em J. Arid Environ.} {\bf 2005}, {\em 63},~\hl{596--614.} %MDPI: We removed extra information. Please check.
...
\newblock 2024. \hl{Available} %MDPI: We added link. Please check and confirm.
 online: \url{https://gee-community-catalog.org/projects/S2TSLULC/#class-definitions} \hl{(accessed on)} %MDPI: Please add the access date (Format: Date Month Year). e.g., (accessed on 1 January 2020).
.
...
\newblock Remote Sensing from Satellites. In {\em Reference Module in Earth
  Systems and Environmental Sciences}; Elsevier:  \hl{Amsterdam, The Netherlands,} %newly added information, please confirm
  2014.
...
\newblock {\em J. Arid Environ.} {\bf 2004}, {\em 59},~\hl{481--498.} %MDPI: We removed extra information. Please check. Same below.
\newblock
...
\newblock {\em J. Arid Environ.} {\bf 2004}, {\em 59},~\hl{427--462.}
...
\newblock In {\em Remote Sensing and Global Environmental Change}; John Wiley
  \& Sons Ltd.:  \hl{Hoboken, NJ, USA,} %newly added information, please confirm
...
\newblock {\em J. Arid Environ.} {\bf 2004}, {\em 59},~\hl{565--582.}
...
\newblock Impacts of land use and climate change on carbon dynamics in
  south-central Senegal.
\newblock {\em J. Arid Environ.} {\bf 2004}, {\em 59},~\hl{583--604.}
...
\newblock {\em J. Arid Environ.} {\bf 2004}, {\em 59},~\hl{535--564.}
...
\newblock Amas et sites coquilliers du delta du Saloum (Sénégal): Passé et
  présent.
\newblock {\em L'Anthropologie} {\bf 2017}, {\em 121},~\hl{204--214.}
...
\newblock {\em Geophys. Res. Lett.} {\bf 2011}, \hl{{\em 38}.} %MDPI: Please provide pagination if available.
...
\newblock {\em Glob. Planet. Chang.} {\bf 2008}, {\em 64},~\hl{210--221.}
...
\newblock Management strategies for coastal erosion problems in west Africa:
  ...
  Benin.
\newblock {\em Ocean Coast. Manag.} {\bf 2018}, {\em 156},~\hl{92--106.}
...
\newblock \hl{Botanical field-study and remote sensing to describe mangrove
  resilience in the Saloum Delta (Senegal) after 30 years of degradation
  narrative.} %MDPI: References 65 and 91 are the same. That is not allowed. Please revise so that there is no duplicated references.
...
\newblock {\em J. Arid Environ.} {\bf 2004}, {\em 59},~\hl{625--642.}
...
\newblock Dynamique de la mangrove de l’estuaire du Saloum (S{\'e}n{\'e}gal)
  ...
  1972 to 2010.
\newblock {\em Cybergeo Eur. J. Geogr. Environ. Nat. Paysage} \hl{{\bf 2013}.} %MDPI: Please provide volume and pagination if available.
