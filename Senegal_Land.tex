...
\caption{Landsat images covering the Cape Verde Peninsula region and Saloum River Delta, West Senegal in February: \textbf{(a)}: 2015; \textbf{(b)}: 2018; \textbf{(c)}: 2020; \textbf{(d)}: 2021; \textbf{(e)}: 2022; \textbf{(f)}: 2023.}\label{fig09}
\end{figure} 
...
\caption{Classification of the Landsat images on 2020 covering the Cape Verde Peninsula region and Saloum River Delta, West Senegal: \textbf{(a)}: February 2015; \textbf{(b)}: February 2018; \textbf{(c)}: February 2020; \textbf{(d)}: February 2021; \textbf{(e)}: February 2022; \textbf{(f)}: February 2023.}\label{fig09}
\end{figure} 
...
\caption{Accuracy evaluated based on the pixel confidence levels with rejection probability values for the Landsat images on 2015 covering the Cape Verde Peninsula region and Saloum River Delta, West Senegal: \textbf{(a)}: February 2015; \textbf{(b)}: February 2018; \textbf{(c)}: February 2020; \textbf{(d)}: February 2021; \textbf{(e)}: February 2022; \textbf{(f)}: February 2023.}\label{fig09}
\end{figure} 
