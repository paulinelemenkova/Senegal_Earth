...
All Landsat images are multispectral and have 30 m resolution in visible spectral bands and are stored in Universal Transverse Mercator (UTM) Zone 28 for western Senegal. It is well known that the high-resolution commercial satellite images (e.g., SPOT, Pleiades) are especially expensive due to the costs of the launch of the satellite, and related operational costs. Therefore, such scenes are not always easily accessible as data source. Hence, the solutions on the open source Landsat 8-9 OLI/TIRS are crucial, and the value of applications of the Landsat products in environmental monitoring projects are high, especially in view of the continuation of the research in future similar works using other Landsat data. The Landsat images used in this study in RGB colours are presented in Figure \ref{fig03}.
...
\vfill \vspace{1mm}
\hspace{30pt}\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.43\textwidth}
		\centering
...
\hspace{50pt}\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.42\textwidth}
		...
		\caption{\hl{SVM: February 2021}}
	\end{subfigure}%
	\begin{subfigure}[b]{.40\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{Fig_08e.jpg}
		\caption{\hl{SVM: February 2022}}
	\end{subfigure}%
	\begin{subfigure}[b]{.40\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{Fig_08f.jpg}
		\caption{\hl{SVM: February 2023}}
	\end{subfigure}%
}
