...
\hl{With this regards, the research questions formulated in this study are as follows: 1) Can the machine learning (ML)-based land cover detection be used in the Geographic Information System (GIS) for satellite image analysis ? 2) How can the Support Vector Machine (SVM) algorithm of ML be employed as geoinformation extracting tasks using scripts ? 3) What is the workflow for the remote sensing data processing for effective chain of data handling to perform all the necessary tasks ? Answering these questions enables to evaluate the effectiveness of the ML applications in cartographic tasks and RS data analysis.}
