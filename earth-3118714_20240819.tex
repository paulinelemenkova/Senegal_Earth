...
The methodology of this study uses three scripting software for data processing, with all the programming scripts shown in the Appendix \ref{App2} section of this study, for technical reference. In view of the advantage of the GRASS GIS approach to analyse the spectral properties of the images by specially adjusted modules along with the applications of the GMT-based cartographic methods of mapping, this paper presents a series of scripting experiments aimed at evaluating land cover type properties in Senegal from 2015 to 2023 using methods of applied programming. 

The advanced script-based cartographic methods of monitoring and mapping land cover types are built on the growing demand for the time- and cost-effective approaches in cartographic workflow and remote sensing data analysis, which enable to save time and resources while processing geospatial datasets, and use open source satellite images. Hence, three major script-based toolsets were used in this study for geospatial data analysis and environmental monitoring of West Africa:
