...
\Title{\textcolor{blue}{Support Vector Machine }for \textcolor{blue}{Mapping }Land Cover \textcolor{blue}{Dynamics} in Senegal, West Africa, Evaluated Using Earth Observation Data}

% MDPI internal command: Title for citation in the left column
\TitleCitation{\hl{Support Vector Machine for Mapping} Land Cover \hl{Dynamics} in Senegal, West Africa, Evaluated Using Earth Observation Data}
...
Recent studies reported a drastic loss in mangrove ecosystems which are currently experiencing effects from climate changes and anthropogenic activities \cite{ANDRIEU2020117963} as well as local effects of soil salinity \cite{Devaney}. Understanding the dynamics of these unique wetland ecosystems is possible using spatial analysis of the remote sensing data which enables to evaluate  gains and losses in landscape patches. Satellite image analysis supports our understanding of the variations in  Senegalese landscapes, and enables to indicate how they react on the effects of changing climate of West Africa, such as increased temperatures and evaporation, and decreased precipitation. The main purpose of this paper is to provide an advanced approach to remote sensing data analysis and processing that can assess the nonlinear behaviour of landscapes in West Africa over time indicating the development of climate setting and the related response of vegetation patterns. Remote sensing data analysis serves as a cartographic basis to support the selection of the optimised decisions in environmental policy makers and planners, allowing the identification of vulnerable landscapes and enabling to monitor degraded lands in Senegal. To this end, a series of the multispectral satellite images Landsat with recent OLI/TIRS sensors was processed with various modules of GRASS GIS and compared for scenes taken on different years, as experimentally used for times series analysis for monitoring landscape dynamics in Senegal. 

To address the main difficulties in traditional image processing, namely presence of structured noise on classified scenes, poor quality or images related to misinterpretation of pixels and low speed of data handling, we propose a script-based classification and image enhancement technique by the GRASS GIS to analyse land cover changes in the coastal region of West Senegal. The goal of using the GRASS GIS scripts for remote sensing data analysis is to quantitatively evaluate changes in land cover types of Senegal during climate fluctuations of recent eight years using automated unsupervised classification. In this way, the maximal likelihood classification algorithm presents the effective means by which the raster Landsat scenes were processed automatically. The remote sensing data obtained from the USGS repository was used for analysis and environmental monitoring to analyse the variations in landscape patches as a response to climate and anthropogenic effects, as indicated by varied spectral reflectance on the images. 

Importantly, the study presented here is not intended to suggest that scripting methods replace the traditional GIS. In contrast, the programming codes can supplement the traditional cartographic methods used in the remote sensing software. However, the integration of scripting workflow with image analysis tasks and cartographic plotting provides an effective approach by which the analysis of land cover changes can be visualised in the automatic way. The main contribution of this paper is as follows: 
